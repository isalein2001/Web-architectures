...
const copy = {
  de: {
    ...
    text: 'Notwendige Cookies halten Login und Sicherheit am Laufen. Mit deiner Zustimmung helfen uns anonyme Nutzungsdaten dabei, Workouts, Analysen und die App sinnvoll zu verbessern.',
    necessary: 'Notwendig',
    necessaryText: 'Login, Sicherheit und deine Cookie-Auswahl. Immer aktiv.',
    analytics: 'Produkt-Analytics',
    analyticsText: 'Zeigt uns z. B., welche Funktionen genutzt werden – ohne Werbetracking oder Datenverkauf.',
  ...
  en: {
    ...
    text: 'Essential cookies keep login and security working. With your permission, anonymous usage data helps us improve workouts, analytics and the app.',
    necessary: 'Essential',
    necessaryText: 'Login, security and your cookie choice. Always active.',
    analytics: 'Product analytics',
    analyticsText: 'Shows us which features are used – without ad tracking or selling data.',
